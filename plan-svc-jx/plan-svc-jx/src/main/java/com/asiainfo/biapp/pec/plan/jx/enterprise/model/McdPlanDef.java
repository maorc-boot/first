...
@ApiModel(value = "EnterPriseMapper对象",description = "产品管理表")
public class McdPlanDef implements Serializable {
  ...
  @ApiModelProperty(value = "产品类别1:流量;2:新增;3:终端;4:两网;5:宽带;6:存量;7:政企;9:其他;10:手机应用;999:虚拟类政策;")
  @TableField("PLAN_TYPE")
  private String planType;

  @ApiModelProperty(value = "产品类型1:单产品;2:政策;3:规则;4:内容;")
  @TableField("PLAN_SRV_TYPE")
  private String planSrvType;

  @ApiModelProperty(value = "产品状态0:未上线;1:已上线;2:待确认;3:待添加;4:已添加;")
  @TableField("STATUS")
  private long status;
  ...
  @ApiModelProperty(value = "数据来源1:全网标准化产品;2;咪咕产品(数字内容产品);3:互联网产品;4:省公司产品;")
  @TableField("DATA_SOURCE")
  private long dataSource;

  @ApiModelProperty(value = "计费方式1:CPC;2:CPM;")
  @TableField("FEE_MODEL")
  private long feeModel;
  ...
  @ApiModelProperty(value = "产品促销资源状态2:待确认;3:已确认;4:已添加资源;")
  ...
  @ApiModelProperty(value = "特殊营销产品类型0:普通营销产品;1:政企营销产品;")
  @TableField("PLAN_CLASS")
  private long planClass;

  @ApiModelProperty(value = "产品分类(业务)")
  @TableField("PLAN_CLASS_BUSI")
