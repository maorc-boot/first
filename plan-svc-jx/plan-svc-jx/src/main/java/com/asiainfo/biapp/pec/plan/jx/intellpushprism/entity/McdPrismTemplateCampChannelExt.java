...
@TableName("mcd_prism_template_camp_channel_ext")
@ApiModel(value="McdPrismTemplateCampChannelExt对象", description="智推棱镜我的模板-策略渠道运营位扩展属性表")
public class McdPrismTemplateCampChannelExt extends Model<McdCampChannelExt> {
