...
@TableName("mcd_camp_channel_list")
@ApiModel(value="McdCampChannelListJx对象", description="策略执行基础属性表")
public class McdCampChannelListJx extends Model<McdCampChannelListJx> {
    ...
    @ApiModelProperty(value = "客户群周期 0：周期性，1：一次性")
    ...
    @ApiModelProperty(value = "策略优先级0-1，0最高，重复按创建时间排")
