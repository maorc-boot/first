...
/**
 * description: 智推棱镜：模板下场景表实体对象
 *
 * @author: lvchaochao
 * @date: 2024/5/15
 */
@TableName("MCD_PRISM_DIM_TEMPLATE_SCENE")
@ApiModel(value = "McdPrismDimTemplateScene对象",description = "智推棱镜模板下场景表实体对象")
@Data
public class McdPrismDimTemplateScene {
