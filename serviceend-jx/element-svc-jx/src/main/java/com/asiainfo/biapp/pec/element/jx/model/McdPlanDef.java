...
@ApiModel(value = "江西McdPlanDef对象", description = "江西McdPlanDef对象")
public class McdPlanDef implements Serializable {
    ...
    @ApiModelProperty(value = "产品类型 1：单产品 2：政策 3：规则 5：内容 9虚拟产品")
    @TableField("PLAN_SRV_TYPE")
    private String planSrvType;

    @ApiModelProperty(value = "产品状态 0 未上线,1已上线, 2:待确认  3：待添加    4：已添加")
    @TableField("STATUS")
